package com.liferay.cli.file.undo;
 ...
 * <p>
 * Note that the complexities of file system I/O are significant and Java does
 * not provide full access to a file lock API that would simplify coding of
 * implementations. Therefore undoing changes to the file system is a
 * best-effort basis only, and designs should not rely on robust, guaranteed,
 * fail-safe undo semantics.
 * 
 * @author Ben Alex
 * @since 1.0
 */
public interface UndoManager {
     ...
     * .
     * <p>
     * The first operation that returns false to
     * {@link UndoableOperation#undo()} will cause the remainder of the
     * {@link Stack} to stop undoing.
     * <p>
     * Executing this command guarantees the {@link Stack} will be empty upon
     * return, with every element either undone or reset.
     * 
     * @return true if all {@link UndoableOperation}s in the {@link Stack} were
     *         successfully undone
     */
    boolean undo();
}